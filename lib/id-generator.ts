 ...
 * Example: "2025Alpha-ABC12-1"
 *
 * @param fantasyLeagueId - The fantasy league ID
 * @param userId - The owner's user ID (integer)
...
/**
 * User IDs are now auto-incrementing integers
 * This function is kept for compatibility but is not used
 * The database will automatically assign IDs starting from 1
 */
export function generateUserId(): number {
  throw new Error("User IDs are now auto-generated by the database. Do not call this function.");
}
