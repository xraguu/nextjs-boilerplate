...
// Mock league data - replace with API call
const mockLeagueData = {
  ...
  upcomingMatchup: {
    opponent: "Air Dribble Demons",
    opponentManager: "Rover",
    week: 3
  }
};
    ...
    <>
      ...
      <section className="card" style={{ marginBottom: "1.5rem", padding: "1.5rem 2rem" }}>
        <div style={{
          ...
          {league.yourTeam.name} • Record: <span style={{ color: "#22c55e", marginLeft: "0.5rem" }}>{league.yourTeam.record.wins}</span>-<span style={{ color: "#ef4444" }}>{league.yourTeam.record.losses}</span> • Rank: <span style={{ color: "var(--accent)", marginLeft: "0.5rem" }}>#{league.yourTeam.rank}</span> • Total Points: <span style={{ color: "var(--accent)", marginLeft: "0.5rem" }}>{league.yourTeam.totalPoints}</span>
        </div>
      </section>
