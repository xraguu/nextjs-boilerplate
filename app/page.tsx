...
// Mock top performing teams - these are the actual MLE teams performing best
const mockTopTeams = [
  { rank: 1, teamName: "Flames CL", tier: "Champion", division: "CL", weekPoints: 48.5, totalPoints: 425.0, wins: 7, losses: 1, gameScore: 18, ppg: 53.1 },
  { rank: 2, teamName: "Torch ML", tier: "Master", division: "ML", weekPoints: 46.0, totalPoints: 398.5, wins: 6, losses: 2, gameScore: 16, ppg: 49.8 },
  { rank: 3, teamName: "Puffins CL", tier: "Champion", division: "CL", weekPoints: 45.5, totalPoints: 385.0, wins: 6, losses: 2, gameScore: 15, ppg: 48.1 },
  { rank: 4, teamName: "Eclipse ML", tier: "Master", division: "ML", weekPoints: 44.0, totalPoints: 372.5, wins: 5, losses: 3, gameScore: 14, ppg: 46.6 },
  { rank: 5, teamName: "Vortex CL", tier: "Champion", division: "CL", weekPoints: 43.5, totalPoints: 368.0, wins: 5, losses: 3, gameScore: 13, ppg: 46.0 },
  { rank: 6, teamName: "Lightning DL", tier: "Diamond", division: "DL", weekPoints: 42.0, totalPoints: 356.0, wins: 5, losses: 3, gameScore: 12, ppg: 44.5 },
  { rank: 7, teamName: "Phoenix ML", tier: "Master", division: "ML", weekPoints: 40.5, totalPoints: 342.5, wins: 4, losses: 4, gameScore: 11, ppg: 42.8 },
  { rank: 8, teamName: "Storm CL", tier: "Champion", division: "CL", weekPoints: 39.5, totalPoints: 335.0, wins: 4, losses: 4, gameScore: 10, ppg: 41.9 },
  { rank: 9, teamName: "Blaze DL", tier: "Diamond", division: "DL", weekPoints: 38.0, totalPoints: 322.5, wins: 3, losses: 5, gameScore: 9, ppg: 40.3 },
  { rank: 10, teamName: "Thunder PL", tier: "Platinum", division: "PL", weekPoints: 36.5, totalPoints: 308.0, wins: 3, losses: 5, gameScore: 8, ppg: 38.5 }
];
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
                <tr style={{ borderBottom: "2px solid rgba(255,255,255,0.1)" }}>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "left", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>Rank</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "left", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>Team</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "left", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>Tier</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "center", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>W-L</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "center", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>GS</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "right", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>Week Pts</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "right", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>Total Pts</th>
                  <th style={{ padding: "0.75rem 0.5rem", textAlign: "right", fontSize: "0.85rem", color: "var(--text-muted)", fontWeight: 600 }}>PPG</th>
                </tr>
              </thead>
              <tbody>
                {mockTopTeams.map((team) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "0.75rem 0.5rem", fontWeight: 600, fontSize: "0.95rem" }}>
                      {team.teamName}
                    </td>
                    ...
                    <td style={{ padding: "0.75rem 0.5rem", textAlign: "center", fontWeight: 600, color: "var(--text-muted)" }}>
                      {team.gameScore}
                    </td>
                    <td style={{ padding: "0.75rem 0.5rem", textAlign: "right", fontWeight: 700, color: "var(--accent)" }}>
                      {team.weekPoints.toFixed(1)}
                    </td>
